            ...
            <div class="pdf-page">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <span><img src="{{ url('/logo.jpeg') }}" style="margin-top: 0.1%;width: 100px; height:100px;"></span>
                        <b>  <h3 style="color:black; font-size:16px; " >Malawi Law Society</h3></b>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <b> <h1 style="font-size: 24px; margin-top: -3%">{{ $event->event_name }} : Conference Pack Collection Report</h1> </b>
