...
<div class="card" style=" width:80%; margin-top: 4%; margin-left: 19%">

    <h5 class="card-header" style="background-color: red;text-align: center; color:white;font-size: 24px;">Import Excel Data</h5>
    <br>
    ...
    <div class="card-body">
        ...
        @if ($message = Session::get('success'))
            ...
            <br>
        @endif
        <form action="{{url("email_certificates")}}" method="post" enctype="multipart/form-data">
            @csrf
