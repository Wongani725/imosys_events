...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-sm-2">
                    <select onchange="location = this.value;" class="form-select float-start me-2" style="background-color: #696cff; color: white;">
...
{{--                        <p style="color:black; font-size:12px; margin-top: -1%; padding-top: 1px;">info@iim.mw | P.O. Box 2040, Blantyre | 01 835 169 | iim.org.mw</p>--}}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table id="table1">
                            ...
                            @foreach ($registrationsWithParticipants as $registration)
                                <tr>
                                    ...
                                    <td>{{ $registration->status === 'Member' ? $registration->participant : '' }}</td>
                                    <td>{{ $registration->status === 'Non Member' ? $registration->participant : '' }}</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
                        ...
                        <p>Non-members: {{ $nonMemberCount }}</p>
                        ...
                        <table id="table2">
                            ...
                            @foreach ($registrationsWithParticipants as $registration)
                                <tr>
                                    <td>{{ $registration->participant }}</td>
                                    <td>{{ $registration->participant_id }}</td>
                                    <td>{{ $registration->gender === 'Male' ? 'Yes' : '' }}</td>
                                    <td>{{ $registration->gender === 'Female' ? 'Yes' : '' }}</td>
                                </tr>
                        ...
                        <br>
                        <button onclick="downloadTable('table1')" style="background-color: #696cff; color: white;">
                            Download Table 1 as Excel</button>
                        <button onclick="downloadTable('table2')" style="background-color: #696cff; color: white;">
                            Download Table 2 as Excel</button>
