...
!function () {
    ...
    var a = document.querySelector("#orderChart"), n = {
        ...
        fill: {
            type: "gradient",
            gradient: {shade: s, shadeIntensity: .8, opacityFrom: .8, opacityTo: .25, stops: [0, 85, 100]}
        },
    ...
    }, a = (null !== a && new ApexCharts(a, n).render(), document.querySelector("#totalRevenueChart")), n = {
    ...
    }, a = (null !== a && new ApexCharts(a, n).render(), document.querySelector("#growthChart")), n = {
        series: [100],
        labels: ["Total Faults"],
        ...
        plotOptions: {
            radialBar: {
                ...
                dataLabels: {
                    ...
                    }, value: {offsetY: -25, color: r, fontSize: "22px", fontWeight: "500", fontFamily: "Public Sans"}
                }
            }
        },
        ...
        states: {hover: {filter: {type: "none"}}, active: {filter: {type: "none"}}}
    }, a = (null !== a && new ApexCharts(a, n).render(), document.querySelector("#revenueChart")), n = {
        ...
        yaxis: {labels: {show: !1}}
    }, a = (null !== a && new ApexCharts(a, n).render(), document.querySelector("#profileReportChart")), n = {
        chart: {
            height: 80,
            type: "line",
            toolbar: {show: !1},
        ...
        yaxis: {show: !1}
    }, a = (null !== a && new ApexCharts(a, n).render(), document.querySelector("#orderStatisticsChart")), n = {
        ...
        dataLabels: {
            enabled: !1, formatter: function (o, r) {
                return parseInt(o) + "%"
            }
        },
        legend: {show: !1},
            ...
            pie: {
                donut: {
                    ...
                    labels: {
                        ...
                        total: {
                            show: !0, fontSize: "0.8125rem", color: e, label: "Weekly", formatter: function (o) {
                                return "38%"
                            }
                        }
                    }
    ...
    }, a = (null !== a && new ApexCharts(a, n).render(), document.querySelector("#incomeChart")), n = {
        ...
        fill: {
            type: "gradient",
            gradient: {shade: s, shadeIntensity: .6, opacityFrom: .5, opacityTo: .25, stops: [0, 95, 100]}
        },
    ...
    }, a = (null !== a && new ApexCharts(a, n).render(), document.querySelector("#expensesOfWeek")), n = {
        series: [65],
